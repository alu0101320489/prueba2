...
const postDamage_1 = require("../src/routers/usuarioRouters/postDamage");
const postDamage_2 = require("../src/routers/usuarioRouters/postDamage");
chai.use(chaiHttp);
...
describe('POST /damagecalculator', () => {
    let calculator;
    beforeEach(() => {
        calculator = new postDamage_2.CalculatorComponent();
    });
    it('should calculate the damage dealt by a move and return it', (done) => {
        const moveData = {
            cat: "special",
            statsA: [1, 100, 100, 100, 100],
            tipo1A: postDamage_1.Types[1],
            tipo2A: "",
            statsD: [1, 100, 100, 100, 100],
            tipo1D: postDamage_1.Types[6],
            tipo2D: "",
            power: 50,
            moveType: postDamage_1.Types[1]
        };
        chai.request(server)
            .post('/damage')
            .send(moveData)
